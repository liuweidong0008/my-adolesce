...
// 有个很重要的点 StudentMsgListener 不能被spring管理，要每次读取excel都要new，然后里面用到spring可以构造方法传进去
@Slf4j
public class StudentMsgEasyExcelListener extends AnalysisEventListener<HeiMaStudentMsgEasyVo> {
     ...
     * 缓存的数据
     */
    private List<HeiMaStudentMsgEasyVo> cachedDataList = new ArrayList<>(BATCH_COUNT);
    /**
