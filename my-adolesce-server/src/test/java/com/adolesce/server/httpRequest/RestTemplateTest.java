...
import com.adolesce.common.config.RestTemplateConfig;
...
//----------------------以下测试POST特有的-----------------------------
    ...
    public void testPost7(){
       /* String url = SERVER_UTL + "test7";
        ...
        map.put("mykey",myUser);

        ResponseEntity<MyUser> responseEntity = RestTemplateConfig.TEMPLATE.postForEntity(url,map,MyUser.class);
        System.out.println(responseEntity.getBody());
    }
