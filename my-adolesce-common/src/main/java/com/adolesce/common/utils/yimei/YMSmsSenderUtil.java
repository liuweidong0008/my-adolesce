package com.adolesce.common.utils.yimei;


import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.crypto.digest.MD5;
import com.adolesce.common.utils.AES;
import com.adolesce.common.utils.GZIPUtils;
import com.adolesce.common.utils.yimei.bean.ResultModel;
import com.adolesce.common.utils.yimei.bean.YiMeiSendSmsParams;
import com.adolesce.common.utils.yimei.http.*;
import com.adolesce.common.utils.yimei.request.SmsBatchOnlyRequest;
import com.adolesce.common.utils.yimei.request.SmsSingleRequest;
import com.adolesce.common.utils.yimei.response.ResponseData;
import com.adolesce.common.utils.yimei.response.SmsResponse;
...
public class YMSmsSenderUtil {
	...
	public static void main(String[] args) {
		...
		params.setSignName("【美团】");
		params.setMobile("13974834775"); //18390952800
		...
		List<String> mobiles = CollectionUtil.newArrayList("18301327332","18810642800");
	...
	public static boolean textSingleSend(YiMeiSendSmsParams params) {
		...
		requestParams.setContent(params.getSignName()+params.getContent());
		requestParams.setMobile(params.getMobile());
		requestParams.setRequestTime(System.currentTimeMillis());
		requestParams.setRequestValidPeriod(30);
	...
	public static boolean textBatchSend(YiMeiSendSmsParams params) {
		...
		requestParams.setContent(params.getSignName()+params.getContent());
		requestParams.setMobiles((String[]) params.getMobiles().toArray());
		requestParams.setRequestTime(System.currentTimeMillis());
		requestParams.setRequestValidPeriod(30);
		ResultModel result = requestText(params.getAppId(),params.getSecretKey(),
				algorithm,requestParams,params.getUrl(),params.isGzip(),encode);
