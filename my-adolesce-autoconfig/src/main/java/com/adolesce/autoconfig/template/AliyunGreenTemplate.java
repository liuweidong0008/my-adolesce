...
public class AliyunGreenTemplate {
    ...
    private AliyunGreenProperties greenProperties;

    public AliyunGreenTemplate(AliyunGreenProperties greenProperties) {
                ...
                for (Object taskResult : taskResults) {
                    ...
                    if (200 == taskCode) {
                        for (Object sceneResult : sceneResults) {
                            ...
                            //do something
                            System.out.println("当前图片检测场景scene = [" + scene + "]");
                            System.out.println("当前图片检测建议suggestion = [" + suggestion + "]");
                            System.out.println("当前图片检测结果label = [" + label + "]");
                            System.out.println("-------------------------------");
                            resultMap.put("suggestion", suggestion);
